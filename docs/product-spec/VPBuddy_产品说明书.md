> **说明**:本文档是 `VPBuddy_产品说明书_v1.10_2026-06-20.docx` 的 Markdown 渲染副本。
> 原始 .docx 文件同目录保留。
>
> **版本历史**:
> - **v1.0**: 初版
...
> - **v1.10** (2026-06-20): **重要补充** — 加 2 个核心能力:① **疑问窗口**(AI 主动问 VP 没听清/有矛盾/需要确认的地方)② **预准备内容**(AI 主动为 VP 准备客户可能要问的弹药,VP 决定用不用);**关键区分**: 主动推**疑问和准备**(为 VP 服务)✓ vs 主动推**结果或决策**(抢话语权)✗
