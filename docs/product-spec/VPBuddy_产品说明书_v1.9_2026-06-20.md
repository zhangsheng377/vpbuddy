> **说明**:本文档是 `VPBuddy_产品说明书_v1.9_2026-06-20.docx` 的 Markdown 渲染副本。
...
> - **v1.9** (2026-06-20): **进一步简化**: 投屏 = 会议平台原生,**VPBuddy 连投屏按钮都不提供**(VP 在会议客户端自己点共享屏幕);VPBuddy 跟投屏完全无关
>
> 源文件:`VPBuddy_产品说明书_v1.9_2026-06-20.docx`
> 历史备份:[v1](VPBuddy_产品说明书_v1_2026-06-20.docx) · ... · [v1.8](VPBuddy_产品说明书_v1.8_2026-06-20.docx) · [source/0620_*.zip](source/)
...
本质:**方向盘式引导**(v1.5 改),不是"批改已完成的成果";VP 在过程中持续 steer,AI 持续整合。**外发** = VP 想把当前状态导出/发送(VPBuddy 处理);**投屏** = VP 在会议客户端自己点"共享屏幕"(腾讯/飞书/Zoom 都有),**VPBuddy 不参与**——投屏是会议平台的事
