    ...
    pub fn new_with_source(device_id: Option<String>, audio_source: &str) -> Result<Self> {
        match audio_source {
            ...
            "both" => {
                #[cfg(target_os = "windows")]
                {
                    log::warn!("Windows both→mic-only: raw WASAPI COM loopback blocked by windows crate 0.52/0.58 API compat in CI");
...
// =============================================================================
// Windows WASAPI Loopback (cpal fallback — 等 raw COM 编译成功后替换)
// =============================================================================
