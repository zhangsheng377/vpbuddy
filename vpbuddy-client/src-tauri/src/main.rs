// VPBuddy Desktop Client -- Main (P2#6 2026-07-04)


mod config;

use config::{AppState, ClientConfig, AudioConfig, SseConfig, load_client_config, save_gpu_url_to_yaml, get_log_path, set_log_path};
pub use config::client_config_path;
